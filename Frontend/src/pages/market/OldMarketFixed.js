...
const Market = () => {
    ...
    const [price_fluctuation1, setprice_fluctuation1] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation2, setprice_fluctuation2] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation3, setprice_fluctuation3] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation5, setprice_fluctuation5] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation7, setprice_fluctuation7] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation9, setprice_fluctuation9] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation10, setprice_fluctuation10] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation11, setprice_fluctuation11] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation12, setprice_fluctuation12] = useState({
        color: "white",
    });
    ...
    const [price_fluctuation14, setprice_fluctuation14] = useState({
        color: "white",
    });
    ...
    //     let prev_wealth = res1.data.balance,
    //         current_wealth = 0;

    //     for (let i = 0; i < res4.data.length; i++) {
    //         if (res4.data[i].stock_name === "BTC") {
    //             current_wealth +=
    //                 parseInt(pricing1) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "ETH") {
    //             current_wealth +=
    //                 parseInt(pricing2) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "BNB") {
    //             current_wealth +=
    //                 parseInt(pricing3) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "SOL") {
    //             current_wealth +=
    //                 parseInt(pricing5) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "DOT") {
    //             current_wealth +=
    //                 parseInt(pricing7) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "AVAX") {
    //             current_wealth +=
    //                 parseInt(pricing9) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "LINK") {
    //             current_wealth +=
    //                 parseInt(pricing10) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "LTC") {
    //             current_wealth +=
    //                 parseInt(pricing11) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "BCH") {
    //             current_wealth +=
    //                 parseInt(pricing12) * parseInt(res4.data[i].stock_quantity);
    //         } else if (res4.data[i].stock_name === "ETC") {
    //             current_wealth +=
    //                 parseInt(pricing14) * parseInt(res4.data[i].stock_quantity);
    //         }
    //     }
            ...
            try {
                ...
                for (let i = 0; i < res4.data.length; i++) {
                    if (res4.data[i].stock_name === "BTC") {
                        current_wealth +=
                            parseInt(pricing1) *
                            parseInt(res4.data[i].stock_quantity);
                    } else if (res4.data[i].stock_name === "ETH") {
                        current_wealth +=
                            parseInt(pricing2) *
                            parseInt(res4.data[i].stock_quantity);
